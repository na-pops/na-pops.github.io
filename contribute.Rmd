...
The data must be in a format that allows us to estimate the removal and/or distance sampling components, i.e., it must retain the time of observation or distance to bird, either continuous measures of time or distance, or binned-intervals or time or distance are acceptable.
...
![Square root of the number of counts by BCR-State-Province intersections](images/NA-POPS_data_count_map.png "Coverage Map")
